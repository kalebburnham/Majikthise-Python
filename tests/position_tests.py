...
class MakeMoveTests(unittest.TestCase):
    ...
    def test_MakeMoveOnBoard_e4(self):
        ...
        position.board.makeMove(move, WHITE)
    ...
    def test_BoardMakeMove_e4(self):
        ...
        move = Move(Square.E2, Square.E4)
        position.board.makeMove(move, WHITE)
        position.board.unmakeMove(move, WHITE)
    ...
    def test_BoardMakeMove_e4e5(self):
        ...
        position.board.makeMove(whiteMove, WHITE)
        position.board.makeMove(blackMove, BLACK)
    ...
    def test_BoardUnMakeMove_e4e5(self):
        ...
        position.board.unmakeMove(blackMove, BLACK)
        position.board.unmakeMove(whiteMove, WHITE)
